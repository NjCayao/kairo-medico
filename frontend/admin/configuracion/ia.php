    ...
    try {
        ...
        if ($config_ia) {
            ...
            $stmt = $db->prepare("UPDATE configuracion_ia SET 
                ...
                WHERE id = ?");
            $stmt->execute([
                $datos['api_key'], $datos['modelo'], $datos['temperatura'], 
                $datos['max_tokens'], $datos['activo'], $datos['consultas_por_dia'],
                $datos['costo_maximo_dia'], $config_ia['id']
            ]);
        } else {
            // Insertar
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="modelo">
                                    <option value="gpt-4" <?= ($config_ia['modelo'] ?? '') == 'gpt-4' ? 'selected' : '' ?>>GPT-4 (Más preciso)</option>
                                    <option value="gpt-4-turbo" <?= ($config_ia['modelo'] ?? '') == 'gpt-4-turbo' ? 'selected' : '' ?>>GPT-4 Turbo</option>
                                    <option value="gpt-3.5-turbo" <?= ($config_ia['modelo'] ?? '') == 'gpt-3.5-turbo' ? 'selected' : '' ?>>GPT-3.5 Turbo (Más rápido)</option>
                                </select>
                            </div>
            ...
            <div class="col-md-4">
                <div class="card card-warning">
                    ...
                    <div class="card-body">
                        ...
                        <ul>
                            <li>GPT-4: ~$0.03 por consulta</li>
                            <li>GPT-3.5: ~$0.002 por consulta</li>
                        </ul>
                    </div>
                </div>
